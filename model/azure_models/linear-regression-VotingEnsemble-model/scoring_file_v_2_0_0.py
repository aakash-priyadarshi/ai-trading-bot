...
data_sample = PandasParameterType(pd.DataFrame({"Date": pd.Series(["2000-1-1"], dtype="datetime64[ns]"), "Ticker": pd.Series(["example_value"], dtype="object"), "Index_Close": pd.Series([0.0], dtype="float64")}))
