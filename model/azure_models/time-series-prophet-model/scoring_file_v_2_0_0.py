...
data_sample = PandasParameterType(pd.DataFrame({"Date": pd.Series(["2000-1-1"], dtype="datetime64[ns]"), "Open": pd.Series([0.0], dtype="float64"), "High": pd.Series([0.0], dtype="float64"), "Low": pd.Series([0.0], dtype="float64"), "Adj Close": pd.Series([0.0], dtype="float64"), "Volume": pd.Series([0], dtype="int64"), "RSI": pd.Series([0.0], dtype="float64"), "MACD_12_26_9": pd.Series([0.0], dtype="float64"), "MACDh_12_26_9": pd.Series([0.0], dtype="float64"), "MACDs_12_26_9": pd.Series([0.0], dtype="float64"), "BBL_20_2.0": pd.Series([0.0], dtype="float64"), "BBM_20_2.0": pd.Series([0.0], dtype="float64"), "BBU_20_2.0": pd.Series([0.0], dtype="float64"), "BBB_20_2.0": pd.Series([0.0], dtype="float64"), "BBP_20_2.0": pd.Series([0.0], dtype="float64"), "MA": pd.Series([0.0], dtype="float64"), "Ticker": pd.Series(["example_value"], dtype="object")}), enforce_shape=False)
